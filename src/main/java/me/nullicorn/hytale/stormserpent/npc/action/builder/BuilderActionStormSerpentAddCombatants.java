...
import me.nullicorn.hytale.stormserpent.npc.action.ActionStormSerpentAddCombatants;
import me.nullicorn.serpentine.asset.SerpentConfig;

public final class BuilderActionStormSerpentAddCombatants extends BuilderActionBase {
    public static final String COMPONENT_ID = "StormSerpentAddCombatants";
    ...
    public Action build(final BuilderSupport builderSupport) {
        return new ActionStormSerpentAddCombatants(this, builderSupport);
    }

...
public final class ActionStormSerpentAddCombatants extends ActionBase {
    public ActionStormSerpentAddCombatants(
        final BuilderActionStormSerpentAddCombatants builder,

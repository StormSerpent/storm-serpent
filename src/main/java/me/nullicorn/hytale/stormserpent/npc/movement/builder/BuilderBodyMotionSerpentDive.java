...
import me.nullicorn.hytale.stormserpent.npc.movement.BodyMotionSerpentDive;

import javax.annotation.Nullable;

public final class BuilderBodyMotionSerpentDive extends BuilderBodyMotionBase {
    public static final String COMPONENT_ID = "StormSerpentDive";
    ...
    public BodyMotion build(final BuilderSupport builderSupport) {
        return new BodyMotionSerpentDive(this, builderSupport);
    }
